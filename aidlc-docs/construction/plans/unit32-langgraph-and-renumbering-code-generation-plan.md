...
- [x] **Step 1** : `curriculum/unit32_langgraph_stateful_agents/index.md` ファイルの新規作成
...
- [x] **Step 2** : `curriculum/` 配下の既存のフォルダ名を、N ➔ N+1 にそれぞれリネーム（git mv を使用）
...
- [x] **Step 3** : `.vitepress/config.js` の更新
...
- [x] **Step 7** : DevContainer 上での VitePress ビルド検証
