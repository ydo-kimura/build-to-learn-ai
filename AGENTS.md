...
This file is the place to document project-specific guidelines.
Please add technical decisions, architecture, commands, etc. here.

## References

- **Code of Conduct:** Refer to `.agent/rules/`.
- **Workflows:** Refer to `.agent/workflows/`.
- **Skills:** Refer to `.agent/skills/`.
- **Curriculum diagrams:** When creating or editing curriculum figures, follow `.agent/rules/curriculum-diagram-authoring-rules.md`.
