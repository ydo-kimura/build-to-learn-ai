...
<img src="../../assets/units/unit19_rnns_lstms/images/diagram-concept.svg" alt="図解：RNN unrolling" class="unit-diagram" />
...
| モデル | 記憶力 | 得意なこと | 弱点 |
| :--- | :--- | :--- | :--- |
| **RNN** | 短期記憶のみ（直前の言葉だけ） | 短い文章の予測 | 長い文章だと最初の方を忘れる |
...
<img src="../../assets/units/unit19_rnns_lstms/images/diagram-workflow.svg" alt="図解：LSTM gates" class="unit-diagram" />
