...
<img src="../../assets/units/unit02_logistic_regression/images/diagram-sigmoid.svg" alt="線形回帰の不正な出力 vs シグモイドの0〜1確率" class="unit-diagram" />
...
<img src="../../assets/units/unit02_logistic_regression/images/diagram-confusion-matrix.svg" alt="混同行列と適合率・再現率の計算式" class="unit-diagram" />
