...
<img src="../../assets/units/unit24_vector_dbs_rag_from_scratch/images/diagram-concept.svg" alt="図解：RAG pipeline" class="unit-diagram" />
...
<img src="../../assets/units/unit24_vector_dbs_rag_from_scratch/images/diagram-workflow.svg" alt="図解：Vector search" class="unit-diagram" />
...
**【要件】**
- データベースの文書を10個ほど適当に増やしてください（AI関連や会社のルールなど何でもOKです）。
