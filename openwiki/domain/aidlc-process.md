...
- Targeted SVG geometry remediation across multiple audit tranches (Units 1–42): arrow geometry, marker-end alignment, orthogonal routing, label/card clearance, and boundary-to-boundary connector endpoints
- Targeted diagram legibility improvements for 16 source SVGs in Units 01–03, 07–09, and 20
- VitePress site root relocated to `docs/` subdirectory; all scripts and verification paths updated accordingly

**Remaining backlog**: Deeper prose parity review for older English units; Sol targeted SVG geometry remediation still in progress for selected units (see `sol-targeted-svg-geometry-plan.md`).
...
- **Targeted SVG geometry remediation** — Focused correction of 24 source SVGs: arrow geometry, marker-end alignment, orthogonal routing, label/card clearance, and boundary-to-boundary connector endpoints
- **Targeted diagram legibility** — Focused legibility improvements for 16 source SVGs in Units 01–03, 07–09, and 20 (font sizes, whitespace, label placement at 673px page width)
