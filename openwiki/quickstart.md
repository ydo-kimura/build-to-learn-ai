...
| Path | Purpose |
|---|---|
| `/curriculum/` | Japanese curriculum content (root locale) — 43 unit directories |
| `/en/` | English curriculum content (mirror structure) |
| `/assets/units/` | Canonical source for unit images (hero, SVG diagrams, concept PNGs) |
| `/public/assets/` | Deployed copy of assets served by VitePress |
| `/.vitepress/` | VitePress config, theme, and custom CSS |
