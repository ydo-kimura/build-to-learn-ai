...
<p class="unit-hero">
  <img src="/en/assets/units/unit02_logistic_regression/images/hero.png" alt="Hero: sigmoid maps scores to 0–1 probability for binary classification" />
</p>
...
<img src="/en/assets/units/unit02_logistic_regression/images/diagram-sigmoid.svg" alt="Linear regression outputs invalid values vs sigmoid maps to 0–1 probability" class="unit-diagram" />
...
<img src="/en/assets/units/unit02_logistic_regression/images/diagram-confusion-matrix.svg" alt="Confusion matrix with TP, FP, TN, FN and precision/recall formulas" class="unit-diagram" />
